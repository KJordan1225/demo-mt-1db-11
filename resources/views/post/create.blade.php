    ...
    <div class="col-12 col-md-10 col-lg-8">
      <div class="card shadow-sm">
        <div class="card-body p-4">
          ...
          {{-- Adjust the route name to your app. Tenant param keeps it tenant-scoped --}}
          <form method="POST"
            ...
            {{-- Images -> Spatie Media Library (collection: carousel_samples) --}}
            <div class="mb-3">
              <label for="images" class="form-label">Carousel Images</label>
              <input id="images"
                     type="file"
                     name="images[]"
            ...
            {{-- Simple client-side previews (optional) --}}
