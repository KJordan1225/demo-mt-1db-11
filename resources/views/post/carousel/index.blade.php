  ...
  <div class="card shadow-sm">
    <div class="card-body">
      ...
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        &nbsp;&nbsp;&nbsp;
        <a href="{{ route('tenant.carousel.post.image.upload', ['tenant' => tenant('id')]) }}" class="btn btn-primary btn-sm">Upload Image</a>
        &nbsp;&nbsp;&nbsp;
        <a href="{{ route('tenant.landing', ['tenant' => tenant('id')]) }}" class="btn btn-primary btn-sm">Show Carousel</a>
      </div>      
